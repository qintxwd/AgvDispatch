...
void MsgProcess::interAddSubAgvPosition(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
...
void MsgProcess::interAddSubAgvStatus(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
...
void MsgProcess::interAddSubTask(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
...
void MsgProcess::interAddSubLog(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
...
void MsgProcess::interRemoveSubAgvPosition(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
...
void MsgProcess::interRemoveSubAgvStatus(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
...
void MsgProcess::interRemoveSubTask(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
...
void MsgProcess::interRemoveSubLog(qyhnetwork::TcpSessionPtr conn, const Json::Value &request) {
	Json::Value response;
	response["type"] = MSG_TYPE_RESPONSE;
	response["todo"] = request["todo"];
	response["queuenumber"] = request["queuenumber"];
	...
	while (true)
	{
		...
		if (interval.count() >= position_pub_interval) {
			...
			for (auto c : agvPositionSubers) {
				qyhnetwork::SessionManager::getInstance()->sendSessionData(c, aps);
...
void MsgProcess::processOneMsg(const Json::Value &request, qyhnetwork::TcpSessionPtr session)
{
	...
	g_threadPool.enqueue([&, request,session] {
		...
		typedef std::function<void(qyhnetwork::TcpSessionPtr, const Json::Value &)> ProcessFunction;
